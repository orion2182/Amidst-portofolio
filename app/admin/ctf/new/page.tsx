...
export default function NewCTFPost() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    await savePost("ctf", slug, content);
    router.push("/admin");
  }

  return (
    <div>
      <h2 className="text-2xl font-bold font-space text-text mb-6">New CTF Writeup</h2>
